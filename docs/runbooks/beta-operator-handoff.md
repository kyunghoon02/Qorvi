...
이 문서는 WhaleGraph beta 운영자가 바로 참고하는 handoff 요약본이다. gate 판단은 `/Users/kh/Github/WhaleGraph/docs/runbooks/launch-gates.md`, release closeout 순서는 `/Users/kh/Github/WhaleGraph/docs/runbooks/beta-release-package.md`, 세부 운영 절차는 `/Users/kh/Github/WhaleGraph/docs/runbooks/ops-admin.md`를 따른다.
...
- `/Users/kh/Github/WhaleGraph/docs/architecture/sprint-0-bootstrap.md`
...
- `/Users/kh/Github/WhaleGraph/docs/runbooks/launch-gates.md`
