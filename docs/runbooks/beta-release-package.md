...
이 문서는 WhaleGraph beta open 직전 운영자와 개발자가 함께 확인하는 handoff 패키지다. 상세 gate 판단은 `/Users/kh/Github/WhaleGraph/docs/runbooks/launch-gates.md`를 따르고, 이 문서는 실제 실행 순서와 운영 인계를 다룬다.
...
- `/Users/kh/Github/WhaleGraph/scripts/beta-hardening.sh`
- `/Users/kh/Github/WhaleGraph/scripts/dev-stack.sh`
- `/Users/kh/Github/WhaleGraph/scripts/dev-worker-loop.sh`
...
2. `/Users/kh/Github/WhaleGraph/docs/runbooks/launch-gates.md` 검토 결과
...
- gate source of truth: `/Users/kh/Github/WhaleGraph/docs/runbooks/launch-gates.md`
- launch review: `/Users/kh/Github/WhaleGraph/docs/runbooks/beta-launch-review.md`
- beta open prep: `/Users/kh/Github/WhaleGraph/docs/runbooks/beta-open-prep.md`
- operator handoff: `/Users/kh/Github/WhaleGraph/docs/runbooks/beta-operator-handoff.md`
- admin runbook: `/Users/kh/Github/WhaleGraph/docs/runbooks/ops-admin.md`
