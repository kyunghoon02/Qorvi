...
이 문서는 FlowIntel의 정식 제품 버전을 위한 PRD다.
...
**“온체인 활동을 읽고 smart money, VC, MM, treasury, bridge flow의 의미를 설명하는 AI analyst product”** 로 FlowIntel을 정의한다.
...
FlowIntel은 단순한 주소 조회 도구가 아니라 다음 질문에 답하는 제품이다.
...
FlowIntel은 “확정 판정”보다 **점수 기반 추정**을 기본으로 한다.
...
### 목적
유료 고객과 내부 파트너가 FlowIntel의 해석 결과를 서비스에 재사용할 수 있게 한다.
...
## 8.1 운영 원칙
FlowIntel은 현재 단계에서 외부 데이터 공급자의 **무료 티어만 사용**한다.
...
3. cohort_score / exit_risk / convergence_score 계산 가능
...
**FlowIntel은 raw wallet activity를 읽어 smart money, VC, MM, treasury, bridge flow의 의미를 설명하는 온체인 AI analyst다.**
